...
Route::group([
    ...
    Route::delete('/roles/deleteAll',[RoleController::class,'deleteAllSelectedRoles'])->name('deleteAllSelectedRoles');
    Route::delete('/users/deleteAll',[UserController::class,'deleteAllSelectedUsers'])->name('deleteAllSelectedUsers');
