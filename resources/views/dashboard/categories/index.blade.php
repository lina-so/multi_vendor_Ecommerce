    ...
    <tbody>
     ...
     @forelse ($categories as $category )
        <tr>
            ...
            <td><img src="{{ asset('storage/' . $category->getFirstMedia('categories')->id . '/' . $category->getFirstMedia('categories')->file_name) }}" width="50" height="50"></td>
           @else
     ...
     @empty
     <tr>
        <td colspan="8" style="background-color:#007bff; color:white" class="text-center">No categories Difined</td>
     </tr>
     @endforelse
    </tbody>
</table>
