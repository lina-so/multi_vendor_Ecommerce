...
@section('content')
                ...
                @forelse ($products as $product)
                    <tr>
                        ...
                        @if (isset($product->images))
                            <td> <img src="{{ asset('storage/' . $product->images->first()->path) }}"
                                    alt="{{ $product->name }}" width="50px" height="50px"></td>
                        @else
    ...
    @else
        <p colspan="8" style="background-color:#007bff; color:white" class="text-center">No products
            Difined</p>
    @endif
