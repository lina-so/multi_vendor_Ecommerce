                                ...
                                <tr id="{{ $cart->id }}">
                                        ...
                                        <div class="media" id="{{ $cart->id }}">
                                            ...
                                            <div class="media-body">
                                                ...
                                                @foreach ($options as $optionId => $ValueId)
                                                    @php
                                                        $optionName = isset($optionNames[$optionId])
                                                            ? $optionNames[$optionId]
                                                            : 'Unknown Option';
                                                        $optionValue = isset($optionValues[$ValueId])
                                    ...
                                    <td>
                                        @if (isset($cart->product->offer->compare_price))
                                            <h5>${{ $cart->product->price - ($cart->product->price * $cart->product->offer->compare_price) / 100 }}
                                            </h5>
                                        @else
                                    ...
                                    <td>
                                        <div class="product_count">
                                            ...
                                            <input class="input-number quantityInput" type="number"
                                                value="{{ $cart->quantity }}" min="0" max="10"
                                                id="quantityInput{{ $cart->id }}" data-id="{{ $cart->id }}"
                                                name="quantity">
                                        </div>
                                    </td>
                                    <td>
                                        @if (isset($cart->product->offer->compare_price))
                                            <h5>${{ ($cart->product->price - ($cart->product->price * $cart->product->offer->compare_price) / 100) * $cart->quantity }}
                                            </h5>
                                        @else
